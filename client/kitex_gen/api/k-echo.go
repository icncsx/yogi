...
func (p *RoomConfig) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
...
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RoomConfig[fieldId]), err)
SkipFieldError:
...
func (p *RoomConfig) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *RoomConfig) FastWrite(buf []byte) int {
	return 0
}

func (p *RoomConfig) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "RoomConfig")
	if p != nil {
...
func (p *RoomConfig) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("RoomConfig")
	if p != nil {
		l += p.field1Length()
	}
...
func (p *RoomConfig) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "multiChatMode", thrift.BOOL, 1)
	offset += bthrift.Binary.WriteBool(buf[offset:], p.MultiChatMode)

	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
	return offset
}

func (p *RoomConfig) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("multiChatMode", thrift.BOOL, 1)
	l += bthrift.Binary.BoolLength(p.MultiChatMode)
...
func (p *Request) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "roomConfig", thrift.STRUCT, 1)
	offset += p.RoomConfig.FastWriteNocopy(buf[offset:], binaryWriter)
	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
	return offset
}
...
func (p *Request) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("roomConfig", thrift.STRUCT, 1)
	l += p.RoomConfig.BLength()
	l += bthrift.Binary.FieldEndLength()
	return l
}
