...
type RoomConfig struct {
	MultiChatMode bool `thrift:"multiChatMode,1" json:"multiChatMode"`
}
...
func (p *RoomConfig) GetMultiChatMode() (v bool) {
	return p.MultiChatMode
}
func (p *RoomConfig) SetMultiChatMode(val bool) {
	p.MultiChatMode = val
}

var fieldIDToName_RoomConfig = map[int16]string{
	1: "multiChatMode",
}

func (p *RoomConfig) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RoomConfig[fieldId]), err)
SkipFieldError:
...
func (p *RoomConfig) ReadField1(iprot thrift.TProtocol) error {
...
func (p *RoomConfig) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("RoomConfig"); err != nil {
...
func (p *RoomConfig) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("multiChatMode", thrift.BOOL, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteBool(p.MultiChatMode); err != nil {
		return err
	}
...
func (p *RoomConfig) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RoomConfig(%+v)", *p)
}

func (p *RoomConfig) DeepEqual(ano *RoomConfig) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	}
	if !p.Field1DeepEqual(ano.MultiChatMode) {
		return false
	}
	return true
}

func (p *RoomConfig) Field1DeepEqual(src bool) bool {

	if p.MultiChatMode != src {
		return false
	}
	return true
}
...
type Request struct {
	RoomConfig *RoomConfig `thrift:"roomConfig,1" json:"roomConfig"`
}
...
var Request_RoomConfig_DEFAULT *RoomConfig

func (p *Request) GetRoomConfig() (v *RoomConfig) {
	if !p.IsSetRoomConfig() {
		return Request_RoomConfig_DEFAULT
	}
	return p.RoomConfig
}
func (p *Request) SetRoomConfig(val *RoomConfig) {
	p.RoomConfig = val
}
...
func (p *Request) IsSetRoomConfig() bool {
	return p.RoomConfig != nil
}
...
func (p *Request) ReadField1(iprot thrift.TProtocol) error {
	p.RoomConfig = NewRoomConfig()
	if err := p.RoomConfig.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *Request) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("roomConfig", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.RoomConfig.Write(oprot); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *Request) DeepEqual(ano *Request) bool {
	...
	if !p.Field1DeepEqual(ano.RoomConfig) {
		return false
	}
	return true
}

func (p *Request) Field1DeepEqual(src *RoomConfig) bool {

	if !p.RoomConfig.DeepEqual(src) {
		return false
	}
	return true
}
...
func (p *Response) GetStatusCode() (v int64) {
	return p.StatusCode
}
func (p *Response) SetStatusCode(val int64) {
	p.StatusCode = val
}
